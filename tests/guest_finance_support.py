...
class GuestFinanceCase(WalkInCase):
    ...
    def setUpClass(cls):
        ...
        with psycopg.connect(cls.owner_dsn) as conn:
            for grant in (
                'GRANT SELECT ON prsystem.minibar_execution_step,prsystem.minibar_rollback_request TO {}',
                'GRANT SELECT ON prsystem.restaurant_order_record,prsystem.restaurant_order_event TO {}',
                'GRANT UPDATE(invoice_id,state,revision) ON prsystem.restaurant_order_record TO {}',
                'GRANT INSERT ON prsystem.restaurant_order_event,prsystem.restaurant_order_handoff TO {}',
                'GRANT INSERT ON prsystem.restaurant_notification TO {}',

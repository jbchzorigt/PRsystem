...
const FIXTURES = [
  ...
  {
    // The ledger cannot advance a phase the governed state has not: Phase 22 is
    ...
    file: 'phase-status',
    expect: /Phase 22 ledger state cell renders/,
    mutate: (text) =>
      text.replace(
        /^(\| 22 \| Security, concurrency, recovery, and full E2E \| )`NOT STARTED`/m,
        '$1`DONE`',
      ),
  },
  ...
  },
  {
    ...
    file: 'phase-status',
    expect:
      /states Current phase = "23 [^"]*"; the governed value is "22 — Security, concurrency, recovery, and full E2E"/,
    mutate: (text) =>
      text.replace(
  ...
  },
  {
    ...
    file: 'phase-status',
    expect: /Phase 22 ledger state cell renders "`IN PROGRESS`"/,
    mutate: (text) => text.replace(/^(\| 22 \|[^|]*\| )`NOT STARTED`/m, '$1`IN PROGRESS`'),
  },
  {

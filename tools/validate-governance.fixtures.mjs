...
const FIXTURES = [
  ...
  {
    // The ledger cannot advance a phase the governed state has not: Phase 18 is
    ...
    file: 'phase-status',
    expect: /Phase 18 ledger state cell renders/,
    mutate: (text) => text.replace(/^(\| 18 \| Police monitoring \| )`NOT STARTED`/m, '$1`DONE`'),
  },
  ...
  },
  {
    ...
    file: 'phase-status',
    expect: /states Current phase = "19 [^"]*"; the governed value is "18 — Police monitoring"/,
    mutate: (text) =>
      text.replace(
  ...
  },
  {
    ...
    file: 'phase-status',
    expect: /Phase 18 ledger state cell renders "`IN PROGRESS`"/,
    mutate: (text) => text.replace(/^(\| 18 \|[^|]*\| )`NOT STARTED`/m, '$1`IN PROGRESS`'),
  },
  {

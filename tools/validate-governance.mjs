...
const { results, failed } = runGovernanceChecks({
  ...
  phase06ManifestPath: join(IMPL, 'phase-06-evidence.json'),
  phase07ManifestPath: join(IMPL, 'phase-07-evidence.json'),
  ...
  phase12ManifestPath: join(IMPL, 'phase-12-evidence.json'),
  phase13ManifestPath: join(IMPL, 'phase-13-evidence.json'),
});

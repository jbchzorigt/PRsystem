...
**Version:** 1.28 (Phase 15 — the nineteen restaurant ordering, guest access and handoff decisions
move to `COVERED` with code and test references; 210 of 279 `COVERED`)

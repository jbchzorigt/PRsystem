...
**Version:** 1.16 (Phase 05 remediation 1 — the evidence columns of the Phase 05 decisions now name
the canonical port contracts, migration `0004`, the worker consumers and the remediation, HTTP
authorization and end-to-end suites; no status changes, 52 of 279 `COVERED`)
...
| ONB-DEC-006 | Durable idempotent provisioning | 05 | COVERED | `apps/api/src/modules/onboarding/services/provisioning.service.ts`, `apps/api/src/modules/onboarding/worker/onboarding-worker.ts`, `apps/api/src/modules/onboarding/contracts/bullmq-provisioning-signal.ts`, `apps/worker/src/jobs/onboarding.ts`, `packages/db/migrations/0004_onboarding_remediation.sql` | `apps/api/src/modules/onboarding/onboarding.integration.test.ts`, `apps/api/src/modules/onboarding/onboarding.concurrency.test.ts`, `apps/api/src/modules/onboarding/onboarding.remediation1.test.ts`, `apps/worker/src/onboarding.e2e.test.ts`, `apps/worker/src/jobs/onboarding.test.ts`, `apps/api/src/modules/onboarding/contracts/bullmq-provisioning-signal.test.ts` |
| ONB-DEC-007 | Existing account and owner proof, canonical state | 05 | COVERED | `apps/api/src/modules/onboarding/services/onboarding.service.ts`, `apps/api/src/modules/onboarding/repositories/onboarding.repository.ts`, `apps/api/src/modules/onboarding/http/onboarding.controller.ts`, `packages/db/migrations/0003_onboarding_subscription.sql`, `packages/db/migrations/0004_onboarding_remediation.sql` | `apps/api/src/modules/onboarding/onboarding.integration.test.ts`, `apps/api/src/modules/onboarding/onboarding.security.test.ts`, `apps/api/src/modules/onboarding/onboarding.remediation1.test.ts` |
| ONB-DEC-008 | Payment retry, late and duplicate success | 05 | COVERED | `apps/api/src/modules/onboarding/services/provisioning.service.ts`, `apps/api/src/modules/onboarding/repositories/onboarding.repository.ts`, `packages/ports/src/payment-gateway.port.ts`, `packages/db/migrations/0003_onboarding_subscription.sql` | `apps/api/src/modules/onboarding/onboarding.integration.test.ts`, `apps/api/src/modules/onboarding/onboarding.concurrency.test.ts`, `apps/api/src/modules/onboarding/subscription.remediation1.test.ts`, `packages/ports/src/conformance.test.ts` |
...
| SUB-DEC-004 | QPay and Khaan Bank subscription gateways | 05 | COVERED | `packages/ports/src/payment-gateway.port.ts`, `apps/api/src/modules/onboarding/services/provisioning.service.ts`, `apps/api/src/modules/onboarding/services/subscription.service.ts`, `apps/api/src/modules/onboarding/services/onboarding-context.ts` | `apps/api/src/modules/onboarding/onboarding.integration.test.ts`, `apps/api/src/modules/onboarding/onboarding.concurrency.test.ts`, `apps/api/src/modules/onboarding/subscription.remediation1.test.ts`, `apps/api/src/modules/onboarding/onboarding.authorization.http.test.ts`, `packages/ports/src/conformance.test.ts` |
| SUB-DEC-005 | eBarimt per confirmed payment | 05 | COVERED | `apps/api/src/modules/onboarding/services/ebarimt.service.ts`, `packages/ports/src/ebarimt.port.ts`, `apps/api/src/modules/onboarding/repositories/subscription.repository.ts`, `apps/worker/src/jobs/onboarding.ts`, `packages/db/migrations/0003_onboarding_subscription.sql`, `packages/db/migrations/0004_onboarding_remediation.sql` | `apps/api/src/modules/onboarding/subscription.integration.test.ts`, `apps/api/src/modules/onboarding/subscription.remediation1.test.ts`, `packages/ports/src/conformance.test.ts`, `apps/worker/src/jobs/onboarding.test.ts` |
...
| LIFE-DEC-006 | Paid pending upgrade and renewal serialization | 05 | COVERED | `apps/api/src/modules/onboarding/services/subscription.service.ts`, `apps/api/src/modules/onboarding/repositories/subscription.repository.ts`, `packages/db/src/kernel/idempotency.ts`, `packages/db/migrations/0003_onboarding_subscription.sql` | `apps/api/src/modules/onboarding/subscription.integration.test.ts`, `apps/api/src/modules/onboarding/onboarding.concurrency.test.ts`, `apps/api/src/modules/onboarding/subscription.remediation1.test.ts` |

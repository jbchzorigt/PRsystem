...
**Version:** 1.13 (Phase 04 remediation 3 — the 26 decisions stay `COVERED`; the evidence now
includes the derived-key, marker-binding and leased-delivery regressions)

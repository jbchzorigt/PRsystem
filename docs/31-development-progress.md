...
| 5 | Minibar, Restaurant, Operation | [Бүтээгдэхүүн, агуулахын opening/purchase ledger ба Manager UI](48-minibar-warehouse.md)-ийн эхний багц нийтлэгдэж, **522/522 PostgreSQL тест skip-гүй**, дөрвөн browser suite/API/design/token CI-аар баталгаажсан. [Template Draft/Publish/Default](49-minibar-template-authoring.md) дараагийн багц local шалгалтад бэлэн, PostgreSQL CI хүлээгдэж байна. Room configuration/refill, lifecycle/correction, Restaurant/Operation үлдсэн |

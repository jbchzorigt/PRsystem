...
| 5 | Minibar, Restaurant, Operation | [Агуулахын opening/purchase ledger ба Manager UI](48-minibar-warehouse.md), [Template Draft/Publish/Default](49-minibar-template-authoring.md) хоёр багц нийтлэгдэж, **537/537 PostgreSQL тест skip-гүй**, таван browser suite/API/design/token CI-аар баталгаажсан. Room configuration/refill, lifecycle/correction, Restaurant/Operation үлдсэн |

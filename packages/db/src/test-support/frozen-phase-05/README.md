...
`35314ba210f609269863f0b528bbe827e6a5d3ce`. Phase 06's migration is the only
...
`0007_hotel_catalog.sql` is deliberately **not** here. It belongs to the phase
under construction and is the one thing the upgrade applies.

...
export const EXPECTED_SCHEMA_SNAPSHOT: SchemaSnapshot = {
  ...
  rls: [
    { schema: 'platform', table: 'export_artifact', enabled: true, forced: true },
    { schema: 'platform', table: 'idempotency_key', enabled: true, forced: true },
    { schema: 'platform', table: 'inbox_consumption', enabled: true, forced: true },
    { schema: 'platform', table: 'job_run', enabled: true, forced: true },
    { schema: 'platform', table: 'outbox_delivery', enabled: true, forced: true },
    { schema: 'platform', table: 'outbox_event', enabled: true, forced: true },
    { schema: 'platform', table: 'provider_event', enabled: true, forced: true },
  ],

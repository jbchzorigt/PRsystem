...
(() => {
  ...
  async function reconciliationManagerDetail(container,request,onSuccess){
    ...
    try{
      ...
      if(!data.plan?.counts_complete||['APPLIED','CANCELLED'].includes(data.request.state))return;

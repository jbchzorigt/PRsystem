...
(() => {
  ...
  async function roomConfiguration(container,room,after){
    ...
    try{
      ...
      parent.replaceChildren();parent.append(node('h2',`${data.room_number} · Минибарын тохиргоо`),node('p',`Одоогийн горим: ${data.current.mode==='OFF'?'Минибаргүй':'Туршилтын минибартай'}`));
